...
public class MoveWords{
    ...
    private static final String[] validMoves = {  "TIJERAS","LAGARTO", "PAPEL", "SPOCK", "PIEDRA"};
    ...
    public static int checkWinner(String first, String second){
	    ...
	    return ((( second_i== (first_i +1) % validMoves.length )  )||(( second_i== (first_i +2) % validMoves.length )  )) ? GANA: PIERDE;
	}
